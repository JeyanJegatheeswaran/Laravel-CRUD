@extends('layouts.app')
@section('main')
<h5><i class="bi bi-plus-square-fill"></i> New Product</h5>
            <hr>
            <nav class="my-3">
                <ol class="breadcrumb">
                ...
                <form action="/products/store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="mrp" id="mrp" class="form-control @if($errors->has('mrp')) {{'is-invalid'}} @endif" placeholder="M.R.P"  value="{{old('mrp')}}"/>
                            @if($errors->has('mrp'))
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10" class="form-control @if($errors->has('description')) {{'is-invalid'}} @endif" style="resize: none; height: 150px;" placeholder="Enter Description" {{old('description')}}></textarea>
